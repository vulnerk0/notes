# Attacking SMB
`smbmap` offers more than `smbclient`, it allows upload and download operations and when listing the share available on the system it show what permissions  you have for each share ;
```shell
...
![[Pasted image 20250723140557.png]]

...
=======
Other than the obvious request_uri parameter that you might find on a website, sometimes the vulnerability is hidden with in the application. That's why you need to understand the application before testing for any vulnerabilities, I'll list them below:
...
<<<<<<< HEAD
=======
- Use the DNS Rebind technique. Basically you input a domain that resolves to 127.0.0.1 or 0.0.0.0 view [rbndr](https://lock.cmpxchg8b.com/rebinder.html) 
>>>>>>> 416797b1d3d96c9ce3a06893f489296c16f16a48
...
- provide the internal IP to these headers [Check this blog](https://requestly.com/blog/what-are-x-forwarded-headers-and-why-it-is-used/): 
	...
	- X-Real-IP
	- Referer
- There are a couple of schemes that you can use depending on the data you want:
<<<<<<< HEAD
	- http/s:// : use this scheme to access forbidden/internal endpoints 
=======
	- http[s]:// : use this scheme to access forbidden/internal endpoints 
>>>>>>> 416797b1d3d96c9ce3a06893f489296c16f16a48
	- file:// : this scheme allows you to read files from the server filesystem
	- gopher:// : this scheme can send arbitrary bytes to the specified address, this can be used to send arbitrary payloads to an endpoint or communicate with other services such as SMTP or a database.